...
# infer_dir = 'exp/LibriSpeech_3/EEND/gradclip_5_batchsize_32_num_frames_500_noam_lr_1.0_noam_warmup_steps_100000_baseline/infer/simu'
# outpath = 'exp/LibriSpeech_3/EENDC/gradclip_5_batchsize_32_num_frames_500_noam_lr_1.0_noam_warmup_steps_100000_all/change_points.h5'
    ...
    for recid in tqdm(kaldi_obj.wavs):
        with h5py.File(outpath, 'a') as wf:
            if recid not in wf:
                ...
                wf.create_dataset(f'{recid}', data=tracks)
